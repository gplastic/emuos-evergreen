...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'DOOM2.WAD';
    var REMOTE_PACKAGE_BASE = 'DOOM2.WAD';
   ...
   if (!fetched) {
     ...
     dbx.filesGetTemporaryLink({path: '/doom2/' + REMOTE_PACKAGE_NAME}).then(function (response) {
       // noinspection JSCheckFunctionSignatures,JSReferencingMutableVariableFromClosure,JSUnfilteredForInLoop
       fetchRemotePackage(response.link, REMOTE_PACKAGE_SIZE, function(data) {
         if (fetchedCallback) {
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 14604584, "filename": "/doom2.wad"}], "remote_package_size": 14604584, "package_uuid": "abdc4c08-b5ec-43d7-a035-7dada7df2435"});
...
var wasmBinaryFile = 'doomengine.wasm';

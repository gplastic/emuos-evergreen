...
define(["require", "exports", "vs/nls", "vs/base/common/event", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/platform/markers/common/markers", "vs/editor/common/core/range", "vs/editor/browser/editorExtensions", "vs/platform/theme/common/themeService", "vs/editor/common/editorContextKeys", "./gotoErrorWidget", "vs/base/common/strings", "vs/base/common/arrays", "vs/editor/browser/services/codeEditorService", "vs/base/common/errors", "vs/platform/actions/common/actions", "vs/base/common/actions", "vs/platform/keybinding/common/keybinding", "vs/base/common/resources"], function (require, exports, nls, event_1, lifecycle_1, contextkey_1, markers_1, range_1, editorExtensions_1, themeService_1, editorContextKeys_1, gotoErrorWidget_1, strings_1, arrays_1, codeEditorService_1, errors_1, actions_1, actions_2, keybinding_1, resources_1) {
    ...
    let MarkerController = class MarkerController {
        ...
        getOrCreateModel() {
            ...
            const actions = [
                new actions_2.Action(PrevMarkerAction.ID, PrevMarkerAction.LABEL + (prevMarkerKeybinding ? ` (${prevMarkerKeybinding.getLabel()})` : ''), 'show-previous-problem codicon-chevron-up', this._model.canNavigate(), async () => { if (this._model) {
                    this._model.move(false, true);
                } }),
                new actions_2.Action(NextMarkerAction.ID, NextMarkerAction.LABEL + (nextMarkerKeybinding ? ` (${nextMarkerKeybinding.getLabel()})` : ''), 'show-next-problem codicon-chevron-down', this._model.canNavigate(), async () => { if (this._model) {

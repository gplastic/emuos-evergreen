    ...
    class EditorGoToLocation extends BaseEditorOption {
        constructor() {
            ...
            super(38 /* gotoLocation */, 'gotoLocation', defaults, {
                ...
                'editor.gotoLocation.multipleImplemenations': Object.assign({ description: nls.localize('editor.editor.gotoLocation.multipleImplemenattions', "Controls the behavior the 'Go to Implemenations'-command when multiple target locations exist.") }, jsonSubset),
        ...
        validate(_input) {
            ...
            return {
                ...
                multipleImplemenations: (_d = input.multipleImplemenations, (_d !== null && _d !== void 0 ? _d : EditorStringEnumOption.stringSet(input.multipleImplemenations, 'peek', ['peek', 'gotoAndPeek', 'goto']))),

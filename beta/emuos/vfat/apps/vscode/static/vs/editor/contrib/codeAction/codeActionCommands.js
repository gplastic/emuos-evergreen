...
define(["require", "exports", "vs/base/common/lazy", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/bulkEditService", "vs/editor/common/editorContextKeys", "vs/editor/contrib/codeAction/codeAction", "vs/editor/contrib/codeAction/codeActionUi", "vs/editor/contrib/message/messageController", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/platform/markers/common/markers", "vs/platform/notification/common/notification", "vs/platform/progress/common/progress", "./codeActionModel", "./types"], function (require, exports, lazy_1, lifecycle_1, strings_1, editorExtensions_1, bulkEditService_1, editorContextKeys_1, codeAction_1, codeActionUi_1, messageController_1, nls, commands_1, contextkey_1, contextView_1, instantiation_1, keybinding_1, markers_1, notification_1, progress_1, codeActionModel_1, types_1) {
    ...
    async function applyCodeAction(accessor, action, bulkEditService, commandService, editor) {
    ...
    class RefactorAction extends editorExtensions_1.EditorAction {
        ...
        run(_accessor, editor, userArgs) {
            ...
            return triggerCodeActionsForEditorSelection(editor, typeof ((_a = userArgs) === null || _a === void 0 ? void 0 : _a.kind) === 'string'
                ...
                kind: types_1.CodeActionKind.Refactor.contains(args.kind) ? args.kind : types_1.CodeActionKind.None,
                onlyIncludePreferredActions: args.preferred,
            }, args.apply);
        }
    }
    ...
    class SourceAction extends editorExtensions_1.EditorAction {
        ...
        run(_accessor, editor, userArgs) {
            ...
            return triggerCodeActionsForEditorSelection(editor, typeof ((_a = userArgs) === null || _a === void 0 ? void 0 : _a.kind) === 'string'
                ...
                kind: types_1.CodeActionKind.Source.contains(args.kind) ? args.kind : types_1.CodeActionKind.None,
                includeSourceActions: true,
                onlyIncludePreferredActions: args.preferred,
            }, args.apply);
        }
    ...
    class OrganizeImportsAction extends editorExtensions_1.EditorAction {
        ...
        run(_accessor, editor) {
            return triggerCodeActionsForEditorSelection(editor, nls.localize('editor.action.organize.noneMessage', "No organize imports action available"), { kind: types_1.CodeActionKind.SourceOrganizeImports, includeSourceActions: true }, "ifSingle" /* IfSingle */);
        }
    }
    ...
    class FixAllAction extends editorExtensions_1.EditorAction {
        ...
        run(_accessor, editor) {
            return triggerCodeActionsForEditorSelection(editor, nls.localize('fixAll.noneMessage', "No fix all action available"), { kind: types_1.CodeActionKind.SourceFixAll, includeSourceActions: true }, "ifSingle" /* IfSingle */);
        }
    }

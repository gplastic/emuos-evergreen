 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/cancellation", "vs/base/common/color", "vs/base/common/htmlContent", "vs/base/common/lifecycle", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/contrib/colorPicker/color", "vs/editor/contrib/colorPicker/colorDetector", "vs/editor/contrib/colorPicker/colorPickerModel", "vs/editor/contrib/colorPicker/colorPickerWidget", "vs/editor/contrib/hover/getHover", "vs/editor/contrib/hover/hoverOperation", "vs/editor/contrib/hover/hoverWidgets", "vs/editor/contrib/markdown/markdownRenderer", "vs/base/common/arrays", "vs/platform/markers/common/markers", "vs/base/common/resources", "vs/base/common/errors", "vs/platform/opener/common/opener", "vs/editor/contrib/gotoError/gotoError", "vs/base/common/async", "vs/editor/contrib/codeAction/codeAction", "vs/editor/contrib/codeAction/codeActionCommands", "vs/editor/contrib/codeAction/types"], function (require, exports, nls, dom, cancellation_1, color_1, htmlContent_1, lifecycle_1, position_1, range_1, textModel_1, modes_1, color_2, colorDetector_1, colorPickerModel_1, colorPickerWidget_1, getHover_1, hoverOperation_1, hoverWidgets_1, markdownRenderer_1, arrays_1, markers_1, resources_1, errors_1, opener_1, gotoError_1, async_1, codeAction_1, codeActionCommands_1, types_1) {
    "use strict";
    ...
    class ModesContentHoverWidget extends hoverWidgets_1.ContentHoverWidget {
        ...
        getCodeActions(marker) {
            return async_1.createCancelablePromise(cancellationToken => {
                return codeAction_1.getCodeActions(this._editor.getModel(), new range_1.Range(marker.startLineNumber, marker.startColumn, marker.endLineNumber, marker.endColumn), { type: 'manual', filter: { kind: types_1.CodeActionKind.QuickFix } }, cancellationToken);
            });
        }

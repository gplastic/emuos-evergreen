...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/editor/browser/services/codeEditorService", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/platform/configuration/common/configuration", "vs/platform/storage/common/storage", "../referencesModel", "./referencesWidget", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/platform/notification/common/notification", "vs/base/common/async", "vs/editor/contrib/peekView/peekView", "vs/platform/list/browser/listService", "vs/platform/keybinding/common/keybindingsRegistry"], function (require, exports, nls, errors_1, lifecycle_1, codeEditorService_1, instantiation_1, contextkey_1, configuration_1, storage_1, referencesModel_1, referencesWidget_1, range_1, position_1, notification_1, async_1, peekView_1, listService_1, keybindingsRegistry_1) {
        ...
        _gotoReference(ref) {
            ...
            return this._editorService.openCodeEditor({
                ...
                if (this._editor === openedEditor) {
                    ...
                    this.closeWidget();
                    openedEditor.focus();
                    other.toggleWidget(range, async_1.createCancelablePromise(_ => Promise.resolve(model)), (_a = this._peekMode, (_a !== null && _a !== void 0 ? _a : false)));
                }
            }, (err) => {
                this._ignoreModelChangeEvent = false;
    ...
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        primary: 62 /* F4 */,
        secondary: [70 /* F12 */],
        when: exports.ctxReferenceSearchVisible,
        handler(accessor) {
    ...
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        primary: 62 /* F4 */,
        secondary: [70 /* F12 */],
        when: peekView_1.PeekContext.inPeekEditor,
        handler(accessor) {
            withController(accessor, controller => {
                controller.goToNextOrPreviousReference(true);
            });
    ...
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        when: contextkey_1.ContextKeyExpr.and(exports.ctxReferenceSearchVisible, referencesWidget_1.ctxReferenceWidgetSearchTreeFocused),
        handler(accessor) {

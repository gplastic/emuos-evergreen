        ...
        _convertCompletionItem(item, position, id) {
            ...
            if (range) {
                if (extHostTypes_1.Range.isRange(range)) {
                    ...
                    if (!SuggestAdapter._isValidRangeForCompletion(range.inserting, position)

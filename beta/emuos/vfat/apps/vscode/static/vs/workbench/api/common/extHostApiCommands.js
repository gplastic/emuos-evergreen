...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/lifecycle", "vs/workbench/api/common/extHostTypeConverters", "vs/workbench/api/common/extHostTypes", "./apiCommands", "vs/base/common/arrays"], function (require, exports, uri_1, lifecycle_1, typeConverters, types, apiCommands_1, arrays_1) {
    ...
    const newCommands = [
        new ApiCommand('vscode.prepareCallHierarchy', '_executePrepareCallHierarchy', 'Prepare call hierarchy at a position inside a document', [ApiCommandArgument.Uri, ApiCommandArgument.Position], new ApiCommandResult('A CallHierarchyItem or undefined', v => typeConverters.CallHierarchyItem.to(v))),

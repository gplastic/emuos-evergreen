...
define(["require", "exports", "vs/base/common/mime", "vs/base/common/decorators", "vs/editor/common/modes/modesRegistry", "vs/base/common/resources", "vs/workbench/common/editor", "vs/workbench/common/editor/untitledTextEditorModel", "vs/platform/instantiation/common/instantiation", "vs/base/common/event", "vs/workbench/services/textfile/common/textfiles", "vs/platform/label/common/label"], function (require, exports, mime_1, decorators_1, modesRegistry_1, resources_1, editor_1, untitledTextEditorModel_1, instantiation_1, event_1, textfiles_1, label_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * An editor input to be used for untitled text buffers.
     */
    let UntitledTextEditorInput = class UntitledTextEditorInput extends editor_1.EditorInput {
        ...
        createModel() {
            const model = this._register(this.instantiationService.createInstance(untitledTextEditorModel_1.UntitledTextEditorModel, this.preferredMode, this.resource, this.hasAssociatedFilePath, this.initialValue, this.preferredEncoding));
    ...
    UntitledTextEditorInput.MEMOIZER = decorators_1.createMemoizer();
    __decorate([
        UntitledTextEditorInput.MEMOIZER
    ], UntitledTextEditorInput.prototype, "shortDescription", null);
    __decorate([
        UntitledTextEditorInput.MEMOIZER
    ], UntitledTextEditorInput.prototype, "mediumDescription", null);
    __decorate([
        UntitledTextEditorInput.MEMOIZER
    ], UntitledTextEditorInput.prototype, "longDescription", null);
    __decorate([
        UntitledTextEditorInput.MEMOIZER
    ], UntitledTextEditorInput.prototype, "shortTitle", null);
    __decorate([
        UntitledTextEditorInput.MEMOIZER
    ], UntitledTextEditorInput.prototype, "mediumTitle", null);
    __decorate([
        UntitledTextEditorInput.MEMOIZER
    ], UntitledTextEditorInput.prototype, "longTitle", null);

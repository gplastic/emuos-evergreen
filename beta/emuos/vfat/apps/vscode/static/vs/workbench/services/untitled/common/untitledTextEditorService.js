...
define(["require", "exports", "vs/base/common/uri", "vs/platform/instantiation/common/instantiation", "vs/base/common/arrays", "vs/workbench/common/editor/untitledTextEditorInput", "vs/platform/files/common/files", "vs/platform/configuration/common/configuration", "vs/base/common/event", "vs/base/common/map", "vs/base/common/network", "vs/base/common/lifecycle", "vs/platform/instantiation/common/extensions", "vs/base/common/resources"], function (require, exports, uri_1, instantiation_1, arrays, untitledTextEditorInput_1, files_1, configuration_1, event_1, map_1, network_1, lifecycle_1, extensions_1, resources_1) {
    ...
    let UntitledTextEditorService = class UntitledTextEditorService extends lifecycle_1.Disposable {
        ...
        doCreate(resource, hasAssociatedFilePath, mode, initialValue, encoding) {
            ...
            const input = this.instantiationService.createInstance(untitledTextEditorInput_1.UntitledTextEditorInput, untitledResource, !!hasAssociatedFilePath, mode, initialValue, encoding);

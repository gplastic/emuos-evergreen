...
define(["require", "exports", "vs/platform/instantiation/common/instantiation", "vs/platform/editor/common/editor", "vs/workbench/common/editor", "vs/workbench/common/editor/resourceEditorInput", "vs/workbench/common/editor/dataUriEditorInput", "vs/platform/registry/common/platform", "vs/base/common/map", "vs/workbench/services/untitled/common/untitledTextEditorService", "vs/platform/files/common/files", "vs/base/common/network", "vs/base/common/event", "vs/base/common/uri", "vs/base/common/resources", "vs/workbench/common/editor/diffEditorInput", "vs/nls", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/platform/configuration/common/configuration", "vs/base/common/lifecycle", "vs/base/common/arrays", "vs/editor/browser/editorBrowser", "vs/platform/label/common/label", "vs/platform/instantiation/common/extensions", "vs/base/common/types"], function (require, exports, instantiation_1, editor_1, editor_2, resourceEditorInput_1, dataUriEditorInput_1, platform_1, map_1, untitledTextEditorService_1, files_1, network_1, event_1, uri_1, resources_1, diffEditorInput_1, nls_1, editorGroupsService_1, editorService_1, configuration_1, lifecycle_1, arrays_1, editorBrowser_1, label_1, extensions_1, types_1) {
    ...
    let EditorService = class EditorService extends lifecycle_1.Disposable {
        ...
        async doOpenEditor(group, editor, options) {
            return types_1.withNullAsUndefined(await group.openEditor(editor, options));
        }
        ...
        toDiffLabel(input) {
            ...
            if (res.scheme === network_1.Schemas.untitled && !this.untitledTextEditorService.hasAssociatedFilePath(res)) {
    ...
    let DelegatingEditorService = class DelegatingEditorService extends EditorService {
        constructor(editorGroupService, untitledTextEditorService, instantiationService, labelService, fileService, configurationService) {
            super(editorGroupService, untitledTextEditorService, instantiationService, labelService, fileService, configurationService);
        }
        ...
        async doOpenEditor(group, editor, options) {
            ...
            const control = await this.editorOpenHandler((group, editor, options) => super.doOpenEditor(group, editor, options), group, editor, options);
            if (control) {

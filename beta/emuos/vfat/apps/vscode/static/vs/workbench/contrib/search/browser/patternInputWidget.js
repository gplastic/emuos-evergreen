...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/browser/ui/widget", "vs/base/browser/ui/checkbox/checkbox", "vs/base/common/event", "vs/platform/theme/common/themeService", "vs/platform/theme/common/styler", "vs/platform/browser/contextScopedHistoryWidget", "vs/platform/contextkey/common/contextkey", "vs/platform/configuration/common/configuration", "vs/base/common/async"], function (require, exports, nls, dom, widget_1, checkbox_1, event_1, themeService_1, styler_1, contextScopedHistoryWidget_1, contextkey_1, configuration_1, async_1) {
    ...
    let PatternInputWidget = class PatternInputWidget extends widget_1.Widget {
        constructor(parent, contextViewProvider, options = Object.create(null), themeService, configurationService, contextKeyService) {
            ...
            this._register(this.searchOnTypeDelayer = new async_1.Delayer(this.searchConfig.searchOnTypeDebouncePeriod));
            this.render(options);

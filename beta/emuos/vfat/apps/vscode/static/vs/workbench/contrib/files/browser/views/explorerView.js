...
define(["require", "exports", "vs/nls", "vs/base/common/performance", "vs/base/common/decorators", "vs/workbench/contrib/files/common/files", "vs/workbench/contrib/files/browser/fileActions", "vs/workbench/common/editor", "vs/workbench/common/editor/diffEditorInput", "vs/base/browser/dom", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/contrib/files/browser/views/explorerDecorationsProvider", "vs/platform/workspace/common/workspace", "vs/platform/configuration/common/configuration", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/platform/progress/common/progress", "vs/platform/contextview/browser/contextView", "vs/platform/contextkey/common/contextkey", "vs/workbench/common/resources", "vs/workbench/services/decorations/browser/decorations", "vs/platform/list/browser/listService", "vs/base/browser/dnd", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/views/panelViewlet", "vs/platform/label/common/label", "vs/workbench/contrib/files/browser/views/explorerViewer", "vs/platform/theme/common/themeService", "vs/platform/actions/common/actions", "vs/platform/actions/browser/menuEntryActionViewItem", "vs/platform/telemetry/common/telemetry", "vs/workbench/contrib/files/common/explorerModel", "vs/base/common/errors", "vs/workbench/browser/labels", "vs/workbench/browser/parts/views/views", "vs/platform/storage/common/storage", "vs/platform/clipboard/common/clipboardService", "vs/base/common/resources", "vs/base/common/map", "vs/base/common/arrays", "vs/base/common/types", "vs/platform/files/common/files", "vs/base/common/lifecycle", "vs/base/common/event"], function (require, exports, nls, perf, decorators_1, files_1, fileActions_1, editor_1, diffEditorInput_1, DOM, layoutService_1, explorerDecorationsProvider_1, workspace_1, configuration_1, keybinding_1, instantiation_1, progress_1, contextView_1, contextkey_1, resources_1, decorations_1, listService_1, dnd_1, editorService_1, panelViewlet_1, label_1, explorerViewer_1, themeService_1, actions_1, menuEntryActionViewItem_1, telemetry_1, explorerModel_1, errors_1, labels_1, views_1, storage_1, clipboardService_1, resources_2, map_1, arrays_1, types_1, files_2, lifecycle_1, event_1) {
    ...
    let ExplorerView = class ExplorerView extends panelViewlet_1.ViewletPanel {
        ...
        createTree(container) {
            ...
            const isCompressionEnabled = () => this.configurationService.getValue('explorer.compressSingleChildFolders');
            this.tree = this.instantiationService.createInstance(listService_1.WorkbenchCompressibleAsyncDataTree, 'FileExplorer', container, new explorerViewer_1.ExplorerDelegate(), new explorerViewer_1.ExplorerCompressionDelegate(), [filesRenderer], this.instantiationService.createInstance(explorerViewer_1.ExplorerDataSource), {
            ...
            // Bind configuration
            const onDidChangeCompressionConfiguration = event_1.Event.filter(this.configurationService.onDidChangeConfiguration, e => e.affectsConfiguration('explorer.compressSingleChildFolders'));
            ...
            this._register(explorerNavigator.onDidOpenResource(async (e) => {
                ...
                if (selection.length === 1 && !shiftDown) {
                    ...
                    await this.editorService.openEditor({ resource: selection[0].resource, options: { preserveFocus: e.editorOptions.preserveFocus, pinned: e.editorOptions.pinned } }, e.sideBySide ? editorService_1.SIDE_GROUP : editorService_1.ACTIVE_GROUP);
                }
            }));
        ...
        async onSelectResource(resource, reveal = this.autoReveal, retry = 0) {

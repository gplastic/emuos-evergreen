        ...
        registerContainerListeners() {
            ...
            this._register(dom_1.addDisposableListener(this.element, dom_1.EventType.DBLCLICK, e => {
                if (this.isEmpty) {
                    ...
                    this.openEditor(this.untitledTextEditorService.createOrGet(), editor_1.EditorOptions.create({ pinned: true }));
                }
            }));

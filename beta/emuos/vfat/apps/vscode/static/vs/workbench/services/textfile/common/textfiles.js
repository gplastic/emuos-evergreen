...
define(["require", "exports", "vs/platform/files/common/files", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/base/common/buffer", "vs/base/common/types", "vs/base/common/platform"], function (require, exports, files_1, instantiation_1, contextkey_1, buffer_1, types_1, platform_1) {
    ...
    class FileOperationWillRunEvent {
        constructor(_thenables, operation, target, source) {
            this._thenables = _thenables;
    ...
    exports.FileOperationWillRunEvent = FileOperationWillRunEvent;
    class FileOperationDidRunEvent {
        constructor(operation, target, source) {
            this.operation = operation;
            this.target = target;
            this.source = source;
        }
    }
    exports.FileOperationDidRunEvent = FileOperationDidRunEvent;

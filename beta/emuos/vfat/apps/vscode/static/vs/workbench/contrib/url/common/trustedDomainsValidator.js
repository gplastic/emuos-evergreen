...
define(["require", "exports", "vs/base/common/network", "vs/base/common/severity", "vs/base/common/strings", "vs/base/common/uri", "vs/nls", "vs/platform/dialogs/common/dialogs", "vs/platform/opener/common/opener", "vs/platform/product/common/productService", "vs/platform/quickinput/common/quickInput", "vs/platform/storage/common/storage", "vs/workbench/contrib/url/common/trustedDomains", "vs/workbench/services/editor/common/editorService", "vs/platform/clipboard/common/clipboardService"], function (require, exports, network_1, severity_1, strings_1, uri_1, nls_1, dialogs_1, opener_1, productService_1, quickInput_1, storage_1, trustedDomains_1, editorService_1, clipboardService_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let OpenerValidatorContributions = class OpenerValidatorContributions {
        constructor(_openerService, _storageService, _dialogService, _productService, _quickInputService, _editorService, _clipboardService) {
        ...
        async validateLink(resource) {
            ...
            if (isURLDomainTrusted(resource, allTrustedDomains)) {
                ...
                // Configure Trusted Domains
                    ...
                    const pickedDomains = await trustedDomains_1.configureOpenerTrustedDomainsHandler(trustedDomains, domainToOpen, this._quickInputService, this._storageService, this._editorService);
                    // Trust all domains

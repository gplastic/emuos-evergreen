        ...
        onSearchCompleted(completed, duration) {
            ...
            */
            this.telemetryService.publicLog('searchResultsShown', {
                ...
                scheme,
                searchOnTypeEnabled: this.configurationService.getValue('search').searchOnType
            });
            return completed;
        }

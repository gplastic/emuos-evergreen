...
define(["require", "exports", "vs/base/common/errorMessage", "vs/base/common/lifecycle", "vs/base/common/network", "vs/base/common/uri", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/editor/common/services/resolverService", "vs/platform/files/common/files", "vs/workbench/api/common/extHost.protocol", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/untitled/common/untitledTextEditorService", "vs/workbench/services/environment/common/environmentService", "vs/base/common/resources"], function (require, exports, errorMessage_1, lifecycle_1, network_1, uri_1, modeService_1, modelService_1, resolverService_1, files_1, extHost_protocol_1, textfiles_1, untitledTextEditorService_1, environmentService_1, resources_1) {
    "use strict";
    ...
    let MainThreadDocuments = class MainThreadDocuments {
        constructor(documentsAndEditors, extHostContext, modelService, modeService, textFileService, fileService, textModelResolverService, untitledTextEditorService, environmentService) {
    ...
    MainThreadDocuments = __decorate([
        ...
        __param(7, untitledTextEditorService_1.IUntitledTextEditorService),

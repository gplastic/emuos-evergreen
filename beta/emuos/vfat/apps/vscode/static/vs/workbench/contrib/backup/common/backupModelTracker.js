...
define(["require", "exports", "vs/workbench/services/backup/common/backup", "vs/base/common/lifecycle", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/untitled/common/untitledTextEditorService", "vs/platform/files/common/files"], function (require, exports, backup_1, lifecycle_1, textfiles_1, untitledTextEditorService_1, files_1) {
    "use strict";
    ...
    let BackupModelTracker = class BackupModelTracker extends lifecycle_1.Disposable {
        constructor(backupFileService, textFileService, untitledTextEditorService) {
            super();

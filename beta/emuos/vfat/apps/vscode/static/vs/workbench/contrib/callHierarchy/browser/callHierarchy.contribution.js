    ...
    editorExtensions_1.registerEditorAction(class extends editorExtensions_1.EditorAction {
        constructor() {
            super({
                ...
                precondition: contextkey_1.ContextKeyExpr.and(_ctxCallHierarchyVisible.negate(), _ctxHasCompletionItemProvider, peekView_1.PeekContext.notInPeekEditor)
            });
        }

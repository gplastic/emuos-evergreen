...
define(["require", "exports", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/strings", "vs/editor/browser/services/bulkEditService", "vs/editor/browser/services/codeEditorService", "vs/editor/common/commands/trimTrailingWhitespaceCommand", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/services/modelService", "vs/editor/contrib/codeAction/codeAction", "vs/editor/contrib/codeAction/codeActionCommands", "vs/editor/contrib/codeAction/types", "vs/editor/contrib/format/format", "vs/editor/contrib/snippet/snippetController2", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/instantiation", "vs/platform/log/common/log", "vs/platform/progress/common/progress", "vs/workbench/api/common/extHostCustomers", "vs/workbench/services/textfile/common/textFileEditorModel", "../common/extHost.protocol"], function (require, exports, async_1, cancellation_1, strings, bulkEditService_1, codeEditorService_1, trimTrailingWhitespaceCommand_1, editOperation_1, position_1, range_1, modelService_1, codeAction_1, codeActionCommands_1, types_1, format_1, snippetController2_1, nls_1, commands_1, configuration_1, instantiation_1, log_1, progress_1, extHostCustomers_1, textFileEditorModel_1, extHost_protocol_1) {
    "use strict";
    ...
    let FormatOnSaveParticipant = class FormatOnSaveParticipant {
        ...
        async participate(editorModel, env) {
    ...
    let CodeActionOnSaveParticipant = class CodeActionOnSaveParticipant {
        ...
        async participate(editorModel, env) {
            ...
            const codeActionsOnSave = Object.keys(setting)
                .filter(x => setting[x]).map(x => new types_1.CodeActionKind(x))
                .sort((a, b) => {
        ...
        async applyOnSaveActions(model, codeActionsOnSave, token) {
        ...
        async applyCodeActions(actionsToRun) {
            for (const action of actionsToRun) {
                await this._instantiationService.invokeFunction(codeActionCommands_1.applyCodeAction, action, this._bulkEditService, this._commandService);
            }
        }

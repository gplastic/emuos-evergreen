...
define(["require", "exports", "vs/base/common/resources", "vs/base/browser/ui/iconLabel/iconLabel", "vs/workbench/services/extensions/common/extensions", "vs/editor/common/services/modeService", "vs/workbench/common/editor", "vs/editor/common/modes/modesRegistry", "vs/platform/workspace/common/workspace", "vs/platform/configuration/common/configuration", "vs/editor/common/services/modelService", "vs/workbench/services/untitled/common/untitledTextEditorService", "vs/workbench/services/decorations/browser/decorations", "vs/base/common/network", "vs/platform/files/common/files", "vs/platform/theme/common/themeService", "vs/base/common/event", "vs/platform/label/common/label", "vs/editor/common/services/getIconClasses", "vs/base/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/base/common/types"], function (require, exports, resources, iconLabel_1, extensions_1, modeService_1, editor_1, modesRegistry_1, workspace_1, configuration_1, modelService_1, untitledTextEditorService_1, decorations_1, network_1, files_1, themeService_1, event_1, label_1, getIconClasses_1, lifecycle_1, instantiation_1, types_1) {
    "use strict";
    ...
    let ResourceLabelWidget = class ResourceLabelWidget extends iconLabel_1.IconLabel {
        constructor(container, options, modeService, modelService, decorationsService, labelService, untitledTextEditorService, contextService) {
        ...
        setFile(resource, options) {
            ...
            let description;
            const hidePath = (options && options.hidePath) || (resource.scheme === network_1.Schemas.untitled && !this.untitledTextEditorService.hasAssociatedFilePath(resource));
            if (!hidePath) {
    ...
    ResourceLabelWidget = __decorate([
        ...
        __param(6, untitledTextEditorService_1.IUntitledTextEditorService),

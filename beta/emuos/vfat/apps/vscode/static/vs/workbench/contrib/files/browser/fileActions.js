...
define(["require", "exports", "vs/nls", "vs/base/common/types", "vs/base/common/platform", "vs/base/common/extpath", "vs/base/common/path", "vs/base/common/resources", "vs/base/common/errorMessage", "vs/base/common/strings", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/workbench/contrib/files/common/files", "vs/workbench/services/textfile/common/textfiles", "vs/platform/files/common/files", "vs/workbench/common/editor", "vs/workbench/services/untitled/common/untitledTextEditorService", "vs/platform/quickOpen/common/quickOpen", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/host/browser/host", "vs/workbench/contrib/files/browser/fileCommands", "vs/editor/common/services/resolverService", "vs/platform/configuration/common/configuration", "vs/platform/clipboard/common/clipboardService", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/platform/commands/common/commands", "vs/platform/list/browser/listService", "vs/platform/contextkey/common/contextkey", "vs/base/common/network", "vs/platform/dialogs/common/dialogs", "vs/platform/notification/common/notification", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/editor/editorCommands", "vs/base/common/arrays", "vs/workbench/contrib/files/common/explorerModel", "vs/base/common/errors", "vs/base/browser/dom", "vs/base/common/labels", "vs/css!./media/fileactions"], function (require, exports, nls, types, platform_1, extpath, path_1, resources, errorMessage_1, strings, actions_1, lifecycle_1, files_1, textfiles_1, files_2, editor_1, untitledTextEditorService_1, quickOpen_1, viewlet_1, instantiation_1, host_1, fileCommands_1, resolverService_1, configuration_1, clipboardService_1, modeService_1, modelService_1, commands_1, listService_1, contextkey_1, network_1, dialogs_1, notification_1, editorService_1, editorCommands_1, arrays_1, explorerModel_1, errors_1, dom_1, labels_1) {
    ...
    async function deleteFiles(textFileService, dialogService, configurationService, fileService, elements, useTrash, skipConfirm = false) {
        let primaryButton;
        if (useTrash) {
    ...
    let BaseSaveAllAction = class BaseSaveAllAction extends actions_1.Action {
        constructor(id, label, textFileService, untitledTextEditorService, commandService, notificationService) {
            super(id, label);
    ...
    BaseSaveAllAction = __decorate([
        ...
        __param(3, untitledTextEditorService_1.IUntitledTextEditorService),
    ...
    let CollapseExplorerView = class CollapseExplorerView extends actions_1.Action {
        ...
        async run() {
            const explorerViewlet = await this.viewletService.openViewlet(files_1.VIEWLET_ID);
    ...
    async function openExplorerAndCreate(accessor, isFolder) {
        ...
        await viewletService.openViewlet(files_1.VIEWLET_ID, true);

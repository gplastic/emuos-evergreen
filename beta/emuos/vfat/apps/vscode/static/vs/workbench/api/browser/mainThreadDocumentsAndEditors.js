...
define(["require", "exports", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/map", "vs/editor/browser/editorBrowser", "vs/editor/browser/services/bulkEditService", "vs/editor/browser/services/codeEditorService", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/editor/common/services/resolverService", "vs/platform/files/common/files", "vs/workbench/api/common/extHostCustomers", "vs/workbench/api/browser/mainThreadDocuments", "vs/workbench/api/browser/mainThreadEditor", "vs/workbench/api/browser/mainThreadEditors", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/common/shared/editor", "vs/workbench/browser/parts/editor/textEditor", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/panel/common/panelService", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/untitled/common/untitledTextEditorService", "vs/workbench/services/environment/common/environmentService"], function (require, exports, event_1, lifecycle_1, map_1, editorBrowser_1, bulkEditService_1, codeEditorService_1, modeService_1, modelService_1, resolverService_1, files_1, extHostCustomers_1, mainThreadDocuments_1, mainThreadEditor_1, mainThreadEditors_1, extHost_protocol_1, editor_1, textEditor_1, editorService_1, editorGroupsService_1, panelService_1, textfiles_1, untitledTextEditorService_1, environmentService_1) {
    "use strict";
    ...
    let MainThreadDocumentsAndEditors = class MainThreadDocumentsAndEditors {
        constructor(extHostContext, _modelService, _textFileService, _editorService, codeEditorService, modeService, fileService, textModelResolverService, untitledTextEditorService, _editorGroupService, bulkEditService, panelService, environmentService) {
            this._modelService = _modelService;
            ...
            const mainThreadDocuments = this._toDispose.add(new mainThreadDocuments_1.MainThreadDocuments(this, extHostContext, this._modelService, modeService, this._textFileService, fileService, textModelResolverService, untitledTextEditorService, environmentService));
        ...
        findTextEditorIdFor(inputEditor) {
    ...
    MainThreadDocumentsAndEditors = __decorate([
        ...
        __param(8, untitledTextEditorService_1.IUntitledTextEditorService),

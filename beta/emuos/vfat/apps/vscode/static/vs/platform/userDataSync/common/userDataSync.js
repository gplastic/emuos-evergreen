    ...
    function registerConfiguration() {
        ...
        configurationRegistry.registerConfiguration({
            ...
            properties: {
                'configurationSync.enable': {
                    type: 'boolean',
                    description: nls_1.localize('configurationSync.enable', "When enabled, synchronizes configuration that includes Settings and Extensions."),
                    default: true,
                    scope: 1 /* APPLICATION */
                },
                'configurationSync.enableSettings': {
                    type: 'boolean',
                    description: nls_1.localize('configurationSync.enableSettings', "When enabled settings are synchronized while synchronizing configuration."),
                    default: true,
                    scope: 1 /* APPLICATION */,
                },
                'configurationSync.enableExtensions': {
                    type: 'boolean',
                    description: nls_1.localize('configurationSync.enableExtensions', "When enabled extensions are synchronized while synchronizing configuration."),
                    default: true,
                    scope: 1 /* APPLICATION */,
                },
